...
class Example(QMainWindow):
    ...
    def initUI(self):
        ...
        self.lcd.setStyleSheet("#LCD {background-image: url(pngs/фон.png); border: 2px solid #4c4c4c;}")
    ...
    def onActivated(self, val):
        backgrounds = {'Stylization': '#272727', 'Olds': 'pngs/olds.png', 'Matrix': 'pngs/matrix.png',
                       'Sofa': 'pngs/диван.jpg', 'Low Poly': 'pngs/bg.png', "Anime": 'pngs/anime.jpg',
                       "Pony": 'pngs/pony.jpg', "Савок": 'pngs/фоник.png'}
        if val == 'Color':
            self.palette()
